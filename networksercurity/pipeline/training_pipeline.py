...
from networksercurity.entity.artifact_entity import(
    DataIngestionArtifact,
    DataValidationArtifact,
    DataTransformationArtifact,
    ModelTrainerArtifact
)
from networksercurity.constant.training_pipeline import TRAINING_BUCKET_NAME
from networksercurity.cloud.s3_syncer import S3Sync
from networksercurity.constant.training_pipeline import SAVED_MODEL_DIR
class Trainingpipeline:
    def __init__(self):
        # Initialize the pipeline config, not recursively
    ...
    def start_data_ingestion(self):
        try:
            ...
            logger.info(f"Data ingestion completed. Artifact: {data_ingestion_artifact}")
